...
if game_type == 2:
    ...
    record_deck_csv(player_a, '桥牌.csv01副牌.csv')
    record_deck_csv(player_b, '桥牌.csv02副牌.csv')
    record_deck_csv(player_c, '桥牌.csv03副牌.csv')
    record_deck_csv(player_d, '桥牌.csv04副牌.csv')
if game_type == 3:
    deal_to_multi_players_remain(deck, 3, player_a, player_b, player_c)
    record_deck_csv(player_a, '三人斗地主01副牌.csv')
    record_deck_csv(player_b, '三人斗地主02副牌.csv')
    record_deck_csv(player_c, '三人斗地主03副牌.csv')
    record_deck_csv(player_dumy, '桥牌.csv04副牌.csv')
if game_type == 4:
    deal_to_multi_players_remain(
        deck, 8, player_a, player_b, player_c, player_d)
    record_deck_csv(player_a, '四人斗地主01副牌.csv')
    record_deck_csv(player_b, '四人斗地主02副牌.csv')
    record_deck_csv(player_c, '四人斗地主03副牌.csv')
    record_deck_csv(player_d, '四人斗地主04副牌.csv')
